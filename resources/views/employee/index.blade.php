        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-danger">
                    <button class="float-end btn btn-sm btn-light" type="button" id="btn_add">Add Employee</button>
                </div>
      ...
      $(document).on('click', '.editIcon', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#avatar").html(
              `<img src="storage/image/${response.photo}" width="100" class="img-fluid img-thumbnail">`);
            $("#emp_id").val(response.id);
            $("#emp_avatar").val(response.photo);
          }
        });
      });

    //   update data
    $("#editEmployeeModal").on('submit', function(e) {
            e.preventDefault();
            var form_data = new FormData(document.getElementById("edit_employee_form"));
            $.ajax({
                url: '{{ route('update') }}',
                method: 'post',
                data: form_data,
